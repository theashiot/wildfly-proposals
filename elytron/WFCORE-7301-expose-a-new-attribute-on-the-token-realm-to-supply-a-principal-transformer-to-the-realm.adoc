...
The attributes is optional, therefore the changes here will not impact the ability to import an existing configuration.
...
* Verify that the Principal gets transformed to the expected value based on the supplied principal transformer.
